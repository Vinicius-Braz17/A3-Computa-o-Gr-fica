...
public class Renderer {
    ...
    public static int screenWidth = 900;  //1280  - 640
    public static int screenHeight = 900; //960  - 480
    ...
    public static void init(){        
        ...
        window.addKeyListener(new KeyBoardCena(cena));
